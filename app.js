...
const FLAG_IMG={
  ENG:'./assets/england-st-george.png', SCO:'./assets/scotland-saltire.png', WAL:'./assets/wales-flag.png',
  ZA:'https://flagcdn.com/w80/za.png',NZ:'https://flagcdn.com/w80/nz.png',AU:'https://flagcdn.com/w80/au.png',IT:'https://flagcdn.com/w80/it.png',FR:'https://flagcdn.com/w80/fr.png',IE:'https://flagcdn.com/w80/ie.png',AR:'https://flagcdn.com/w80/ar.png',FJ:'https://flagcdn.com/w80/fj.png',GE:'https://flagcdn.com/w80/ge.png',RO:'https://flagcdn.com/w80/ro.png',TO:'https://flagcdn.com/w80/to.png',JP:'https://flagcdn.com/w80/jp.png',WS:'https://flagcdn.com/w80/ws.png',CA:'https://flagcdn.com/w80/ca.png',US:'https://flagcdn.com/w80/us.png',UY:'https://flagcdn.com/w80/uy.png',NA:'https://flagcdn.com/w80/na.png',PT:'https://flagcdn.com/w80/pt.png',ES:'https://flagcdn.com/w80/es.png',GA:'https://flagcdn.com/w80/ga.png',HK:'https://flagcdn.com/w80/hk.png',KE:'https://flagcdn.com/w80/ke.png',ZW:'https://flagcdn.com/w80/zw.png',BW:'https://flagcdn.com/w80/bw.png',ZM:'https://flagcdn.com/w80/zm.png',UG:'https://flagcdn.com/w80/ug.png'
};
const FLAG_DATA={
  ENG:'data:image/svg+xml;charset=UTF-8,'+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 40"><rect width="60" height="40" fill="#fff"/><path d="M25 0h10v15h25v10H35v15H25V25H0V15h25z" fill="#cf2027"/></svg>'),
  SCO:'data:image/svg+xml;charset=UTF-8,'+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 40"><rect width="60" height="40" fill="#0065bd"/><path d="M0 0h10L60 30v10H50L0 10zM50 0h10v10L10 40H0V30z" fill="#fff"/></svg>'),
  WAL:'data:image/svg+xml;charset=UTF-8,'+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 40"><rect width="60" height="20" fill="#fff"/><rect y="20" width="60" height="20" fill="#00ab39"/><path d="M12 31c8-15 18-17 28-10 6-1 10 2 8 6-3 5-8 4-12 2-5 5-14 7-24 2z" fill="#d80027"/></svg>')
};
...
function flagMarkupByCode(code,cls='inline-flag'){const src=FLAG_DATA[code]||FLAG_IMG[code];return src?`<img class="${cls}" src="${src}" alt="${code} vlag" loading="lazy" onerror="this.onerror=null;this.style.display='none';this.insertAdjacentHTML('afterend','<span class=\"country-flag-emoji\">🌍</span>')">`:''}
...
function teamFlagMarkup(t){const code=FLAG_BY_VALUE[t.flag]||t.flag;if(FLAG_IMG[code])return flagMarkupByCode(code,'team-flag-img');return '<span class="team-flag-emoji">🌍</span>'}
...
const LEKKER_NEWS=[['🔥','BOKKE 29–24 ALL BLACKS','Springboks lei die vier-toets reeks 2–1 ná ’n 29–24 oorwinning by FNB Stadium.','https://springboks.rugby/news-features/articles/2026/9/5/boks-take-series-lead-in-greatest-test','https://media-cdn.cortextech.io/1WWmqT/1BSdBWIjCjnOJp/0544c345-cf03-4181-a9ba-dfa075d540a0.jpg'],['🚑','KOLBE UIT VIR BALTIMORE','Cheslin Kolbe het sy kakebeen gebreek en sal nie die vierde toets teen Nieu-Seeland speel nie.','https://supersport.com/rugby/news/8d2bab1e-c7ec-49b5-a6af-e60e1e1e4c4e/kolbe-breaks-jaw-and-shoulder-injury-sidelines-savea','https://images.supersport.com/media/kr5igkyb/cheslin-kolbe-2000g.jpg'],['⚡','ALL BLACKS GETREF DEUR BESERINGS','Ardie Savea, Quinn Tupaea en Luke Jacobson is uit vir die vierde toets.','https://www.reuters.com/sports/all-blacks-suffer-another-injury-setback-2026-09-06/','https://upload.wikimedia.org/wikipedia/commons/8/89/Luke_Jacobson_LQ_2021.jpg'],['🌏','AUSTRALIË KLINCH REEKS IN ARGENTINIË','Die Wallabies het die reeks in Argentinië gewen nadat die tweede toets 28–28 geëindig het.','https://www.theguardian.com/sport/live/2026/sep/05/arg-vs-aus-wallabies-rugby-union-second-test-live-updates','./assets/lekker-rugby-hero.png'],['🇯🇵','JAPAN KLAP CANADA 57–12','Japan het Kanada in Niigata met 57–12 verslaan.','https://rugby.ca/en/news/2026/09/canada-s-men-s-rugby-team-falls-57-12-in-japan-s-100th-anniversary-match','./assets/lekker-rugby-hero.png'],['🏆','WÊRELRANGLYS','Suid-Afrika is tans #1, voor Nieu-Seeland #2, Ierland #3 en Frankryk #4.','https://springboks.rugby/match-centre/results','./assets/lekker-rugby-hero.png']];
...
const FLAG_REMOTE={
  ENG:'./assets/england-st-george.png',SCO:'./assets/scotland-saltire.png',WAL:'./assets/wales-flag.png',
  ZA:'https://flagcdn.com/w80/za.png',NZ:'https://flagcdn.com/w80/nz.png',AU:'https://flagcdn.com/w80/au.png',IT:'https://flagcdn.com/w80/it.png',FR:'https://flagcdn.com/w80/fr.png',IE:'https://flagcdn.com/w80/ie.png',AR:'https://flagcdn.com/w80/ar.png',FJ:'https://flagcdn.com/w80/fj.png',GE:'https://flagcdn.com/w80/ge.png',RO:'https://flagcdn.com/w80/ro.png',TO:'https://flagcdn.com/w80/to.png',JP:'https://flagcdn.com/w80/jp.png',WS:'https://flagcdn.com/w80/ws.png',CA:'https://flagcdn.com/w80/ca.png',US:'https://flagcdn.com/w80/us.png',UY:'https://flagcdn.com/w80/uy.png',NA:'https://flagcdn.com/w80/na.png',PT:'https://flagcdn.com/w80/pt.png',ES:'https://flagcdn.com/w80/es.png',GA:'https://flagcdn.com/w80/ga.png',RO:'https://flagcdn.com/w80/ro.png',HK:'https://flagcdn.com/w80/hk.png',KE:'https://flagcdn.com/w80/ke.png',ZW:'https://flagcdn.com/w80/zw.png',BW:'https://flagcdn.com/w80/bw.png',ZM:'https://flagcdn.com/w80/zm.png',UG:'https://flagcdn.com/w80/ug.png'};
...
function countryFlagMarkup(meta){
  ...
  return src?`<img class="country-flag-img" src="${src}" alt="${esc(meta.name)} vlag" loading="lazy" onerror="this.onerror=null;this.style.display='none';this.parentNode.insertAdjacentHTML('beforeend','<span class=\"country-flag-emoji\">🌍</span>')">`:`<span class="country-flag-emoji">🌍</span>`;
}
...
function renderNews(){
  ...
  el.innerHTML=items.map(n=>`<article class="news-card"><div class="news-art"><img src="${esc(n[4]||'./assets/lekker-rugby-hero.png')}" alt="${esc(n[1])}" loading="lazy" referrerpolicy="no-referrer" onerror="this.onerror=null;this.src='./assets/lekker-rugby-hero.png'"></div><div><span class="news-source">LEKKER NUUS</span><h3>${esc(n[1])}</h3><p>${esc(n[2])}</p><a href="${esc(n[3])}" target="_blank" rel="noopener noreferrer">LEES VOLLEDIGE BERIG →</a></div></article>`).join('');
}
